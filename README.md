# Logging To Logentries Using Log4net

To configure your application to log to Logentries using Log4Net, you will need to perform the following tasks:

1. Create a Logentries account.
2. Create a host and log to receive your log data.
3. Adding the Log4net and Logentries Log4net Appender libraries to your application.
4. Configure Log4net and the Logentries appender in your application.
...
## Adding Log4net and Logentries Appender Libraries to Your Application

The easiest way to add both the Log4net and the Logentries Appender libraries to your application is to install the `le_log4net` [Nuget package](http://www.nuget.org/packages/le_log4net "Nuget package"). This package will install the Logentries Appender library and will also automatically install the `log4net` package as a dependency.

If you would rather install the Logentries appender manually, you can download the code in this GitHub repository, compile the LeLog4net Visual Studio project within it into a DLL file, and then reference this file in your application. If you choose this option you must install Log4net yourself.
...
Here is an example of how to specify the credentials in the `<appSettings>` element in your App.config och Web.config file:
